...
const createAcademicSemesterValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        startMonth: zod_1.z.enum([...academicSemester_constant_1.Month]),
        endMonth: zod_1.z.enum([...academicSemester_constant_1.Month]),
    }),
});
const updateAcademicSemesterValidationSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        startMonth: zod_1.z.enum([...academicSemester_constant_1.Month]).optional(),
        endMonth: zod_1.z.enum([...academicSemester_constant_1.Month]).optional(),
    }),
});
